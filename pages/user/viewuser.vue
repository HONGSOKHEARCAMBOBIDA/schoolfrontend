  ...
  <div>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr v-for="ts in teacherSubjects" :key="ts.id">
                    ...
                    <td>
                      <span class="badge" :class="ts.is_active ? 'bg-success' : 'bg-danger'">
    ...
    <div class="p-2 pt-5">
      <div class="card border-1  mt-3 mb-3 p-3">
        <div class="row g-3">
          <div class="col-md-4">
            <input type="text" class="form-control" placeholder="ស្វែងរកឈ្មោះ" v-model="filters.nameKh" />
          </div>
          <div class="col-md-4">
                ...
                <table class="table table-hover align-middle">
                  ...
                  <tbody>
                    <tr v-for="user in users" :key="user.id">
                      <td>{{ user.id }}</td>
                      <td>
                        <img v-if="user.image" :src="`http://localhost:8080/images/${user.image}`" alt="User Image"
                      ...
                      <td>
                        <div v-if="user.role_name === 'គ្រូបង្រៀន' && user.classes && user.classes.length > 0">
                          <span v-for="cls in user.classes" :key="cls.id + '-' + cls.academic_year_id"
                      ...
                      <td>
                        <span class="badge px-3 py-2" :class="user.is_active ? 'bg-success' : 'bg-danger'">
                      ...
                      <td>
                        ...
                        <NuxtLink :to="`/user/edit/${user.id}`" class="btn btn-sm btn-warning me-2">
                          <i class="bi bi-pencil-square"></i> កែប្រែ
                        </NuxtLink>
                        <button class="btn btn-sm btn-secondary me-2" @click="openChangePassword(user)">
                          <i class="bi bi-key"></i> ប្ដូរពាក្យសម្ងាត់
                        </button>
                        <button class="btn btn-sm me-2" :class="user.is_active ? 'btn-danger' : 'btn-success'"
                        ...
                        <button class="btn btn-sm btn-info me-2" v-if="user.role_name === 'Teacher'"
